...
We can prove the correctness of the above code by observing that the quantity $$ab + n$$ remains invariant. If $$b$$ is even, then in the next iteration, let $$a'=2a, b'=b/2, n'=n$$. Then:
